                                ...
                                <div class="block block-product-filter clearfix">
                                    ...
                                    <div class="block-content">
                                        <ul class="filter-items image">
                                            <li><span><img src="{{asset('media/brand/1.jpg')}}" alt="Brand"></span></li>
                                            <li><span><img src="{{asset('media/brand/2.jpg')}}" alt="Brand"></span></li>
                                            <li><span><img src="{{asset('media/brand/3.jpg')}}" alt="Brand"></span></li>
                                            <li><span><img src="{{asset('media/brand/4.jpg')}}" alt="Brand"></span></li>
                                            <li><span><img src="{{asset('media/brand/5.jpg')}}" alt="Brand"></span></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <ul class="products-list">
                                            <li class="product-item">
                                                <a href="shop-details.html" class="product-image">
                                                    <img src="{{asset('media/product/6.jpg')}}">
                                                </a>
                                            ...
                                            <li class="product-item">
                                                <a href="shop-details.html" class="product-image">
                                                    <img src="{{asset('media/product/8.jpg')}}">
                                                </a>
                                                <div class="product-content">
                                                    <h2 class="product-title">
                                                        <a href="shop-details.html">
                                            ...
                                            <li class="product-item">
                                                <a href="shop-details.html" class="product-image">
                                                    <img src="{{asset('media/product/9.jpg')}}">
                                                </a>
                                                <div class="product-content">
                                                    <h2 class="product-title">
                                                        <a href="shop-details.html">
                                                    ...
                                                    <div class="products-entry clearfix product-wapper">
                                                        <div class="products-thumb">
                                                            ...
                                                            <div class="product-thumb-hover">
                                                                <a href="shop-details.html">
                                                                    <img width="600" height="600" src="{{asset('media/product/6.jpg')}}" class="post-image" alt="">
                                                                    <img width="600" height="600" src="{{asset('media/product/6-2.jpg')}}" class="hover-image back" alt="">
                                                                </a>
                                                            </div>		
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                    <div class="products-entry clearfix product-wapper">
                                                        <div class="products-thumb">
                                                            ...
                                                            <div class="product-thumb-hover">
                                                                <a href="shop-details.html">
                                                                    <img width="600" height="600" src="{{asset('media/product/4.jpg')}}" class="post-image" alt="">
                                                                    <img width="600" height="600" src="{{asset('media/product/4-2.jpg')}}" class="hover-image back" alt="">
                                                                </a>
                                                            </div>		
                                                            <div class="product-button">
                                                                <div class="btn-add-to-cart" data-title="Add to cart">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                    <div class="products-entry clearfix product-wapper">
                                                        <div class="products-thumb">
                                                            <div class="product-thumb-hover">
                                                                <a href="shop-details.html">
                                                                    <img width="600" height="600" src="{{asset('media/product/7.jpg')}}" class="post-image" alt="">
                                                                    <img width="600" height="600" src="{{asset('media/product/7-2.jpg')}}" class="hover-image back" alt="">
                                                                </a>
                                                            </div>		
                                                            <div class="product-button">
                                                                <div class="btn-add-to-cart" data-title="Add to cart">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                    <div class="products-entry clearfix product-wapper">
                                                        <div class="products-thumb">
                                                            ...
                                                            <div class="product-thumb-hover">
                                                                <a href="shop-details.html">
                                                                    <img width="600" height="600" src="{{asset('media/product/8.jpg')}}" class="post-image" alt="">
                                                                    <img width="600" height="600" src="{{asset('media/product/8-2.jpg')}}" class="hover-image back" alt="">
                                                                </a>
                                                            </div>		
                                                            <div class="product-button">
                                                                <div class="btn-add-to-cart" data-title="Add to cart">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                    <div class="products-entry clearfix product-wapper">
                                                        <div class="products-thumb">
                                                            ...
                                                            <div class="product-thumb-hover">
                                                                <a href="shop-details.html">
                                                                    <img width="600" height="600" src="{{asset('media/product/9.jpg')}}" class="post-image" alt="">
                                                                    <img width="600" height="600" src="{{asset('media/product/9-2.jpg')}}" class="hover-image back" alt="">
                                                                </a>
                                                            </div>		
                                                            <div class="product-button">
                                                                <div class="btn-add-to-cart" data-title="Add to cart">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                    <div class="products-entry clearfix product-wapper">
                                                        <div class="products-thumb">
                                                            ...
                                                            <div class="product-thumb-hover">
                                                                <a href="shop-details.html">
                                                                    <img width="600" height="600" src="{{asset('media/product/10.jpg')}}" class="post-image" alt="">
                                                                    <img width="600" height="600" src="{{asset('media/product/10-2.jpg')}}" class="hover-image back" alt="">
                                                                </a>
                                                            </div>		
                                                            <div class="product-button">
                                                                <div class="btn-add-to-cart" data-title="Add to cart">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                    <div class="products-entry clearfix product-wapper">
                                                        <div class="products-thumb">
                                                            <div class="product-thumb-hover">
                                                                <a href="shop-details.html">
                                                                    <img width="600" height="600" src="{{asset('media/product/11.jpg')}}" class="post-image" alt="">
                                                                    <img width="600" height="600" src="{{asset('media/product/11-2.jpg')}}" class="hover-image back" alt="">
                                                                </a>
                                                            </div>		
                                                            <div class="product-button">
                                                                <div class="btn-add-to-cart" data-title="Add to cart">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                    <div class="products-entry clearfix product-wapper">
                                                        <div class="products-thumb">
                                                            ...
                                                            <div class="product-thumb-hover">
                                                                <a href="shop-details.html">
                                                                    <img width="600" height="600" src="{{asset('media/product/12.jpg')}}" class="post-image" alt="">
                                                                    <img width="600" height="600" src="{{asset('media/product/12-2.jpg')}}" class="hover-image back" alt="">
                                                                </a>
                                                            </div>		
                                                            <div class="product-button">
                                                                <div class="btn-add-to-cart" data-title="Add to cart">
