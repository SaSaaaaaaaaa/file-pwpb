                                        ...
                                        <table class="cart-items table" cellspacing="0">
                                            ...
                                            <tbody>
                                                <tr class="cart-item">		
                                                    <td class="product-thumbnail">
                                                        <a href="shop-details.html">
                                                            <img width="600" height="600" src="{{asset('media/product/3.jpg')}}" class="product-image" alt="">
                                                        </a>				
                                                ...
                                                <tr class="cart-item">		
                                                    <td class="product-thumbnail">
                                                        <a href="shop-details.html">
                                                            <img width="600" height="600" src="{{asset('media/product/1.jpg')}}" class="product-image" alt="">
                                                        </a>				
                                                        <div class="product-name">
