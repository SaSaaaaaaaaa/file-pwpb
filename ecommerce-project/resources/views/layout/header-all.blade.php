                            ...
                            <div class="site-navigation">
                                <nav id="main-navigation">
                                    <ul id="menu-main-menu" class="menu">
                                        ...
                                        <li class="level-0 menu-item">
                                            <a href="{{route('blogs')}}"><span class="menu-item-text">Blog</span></a>
                                        </li>
                                        <li class="level-0 menu-item menu-item-has-children">
                                            <a href="#"><span class="menu-item-text">Pages</span></a>
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="{{route('login')}}"><span class="menu-item-text">Login</span></a>
                                                </li>
                                                <li>
                                                    <a href="{{route('register')}}"><span class="menu-item-text">Register</span></a>
                                                </li>
                                                <li>
                                                    <a href="{{route('forgot-password')}}"><span class="menu-item-text">Forgot Password</span></a>
                                                </li>
                                                <li>
                                                    <a href="{{route('profile')}}"><span class="menu-item-text">My Account</span></a>
                                                </li>
                                                <li>
                                                    <a href="{{route('about-us')}}"><span class="menu-item-text">About Us</span></a>
                                                </li>
                                                <li>
                                                    <a href="{{route('contact')}}"><span class="menu-item-text">Contact</span></a>
                                                </li>
                                                <li>
                                                    <a href="{{route('faq')}}"><span class="menu-item-text">FAQ</span></a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="level-0 menu-item">
